 ...
 */
    ...
    public static List<String> dropdownOptionsAsString(WebElement dropdownsElement){
        Select select = new Select(dropdownsElement);
    ...
    /**
     * this method will accepts a group of radio buttons as a list of WebElement
